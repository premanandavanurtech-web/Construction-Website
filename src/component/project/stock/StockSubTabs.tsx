...
const tabs = [
  { label: "Current Inventory", slug: "current-inventory" }, // ✅ fixed
  ...
  return (
    <div className="border-b mt-7 border-gray-200">
      <div className="flex justify-around gap-10">
        {tabs.map((tab) => {
          const href = `/projects/${projectId}/stock/${tab.slug}`;
          ...
          return (
            <Link
              ...
              className={clsx(
                ...
                isActive ? "text-black" : "text-gray-500 hover:text-slate-800"
              )}
            >
              {tab.label}
              {isActive && (
